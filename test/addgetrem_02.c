...
main(int argc, char *const argv[])
{
	...
	t0 = echs_now();
	pr_bitmp(bitte_get(NULL, (mut_oid_t)"Alice_$200", t0));
	...
	t1 = echs_now();
	pr_bitmp(bitte_get(NULL, (mut_oid_t)"Alice_$200", t0));
	pr_bitmp(bitte_get(NULL, (mut_oid_t)"Alice_$200", t1));

	echs_set_now(dt_strp("2014-10-29T12:02:43.671", NULL));
	bitte_rem(NULL, (mut_oid_t)"Alice_$200");
	t2 = echs_now();
	pr_bitmp(bitte_get(NULL, (mut_oid_t)"Alice_$200", t0));
	pr_bitmp(bitte_get(NULL, (mut_oid_t)"Alice_$200", t1));
	pr_bitmp(bitte_get(NULL, (mut_oid_t)"Alice_$200", t2));
	return 0;
}
